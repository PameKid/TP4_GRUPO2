...
<body>
	...
	<form method="post" action="AgregarSeguroServlet">
		...
		<label>Tipo de seguro:</label> <select name="idTipoSeguro" required>
		...
		<label>Costo contratación:</label> <input type="number"
			name="costoContratacion" step="0.01" required> <br>
		<br> <label>Costo máximo asegurado:</label> <input type="number"
			name="costoMaximoAsegurado" step="0.01" required> <br>
		<br> <input type="submit" value="Agregar Seguro"> <a
			href="Inicio.jsp">
